...
if __name__ == "__main__":
    ...
    print("\nComparison Summary:")
    print(f"  Total VM Demand:    CPU = {total_vm_demand[0]}, RAM = {total_vm_demand[1]}")
    print(f"  Total PM Usage:     CPU = {total_used_pm[0]}, RAM = {total_used_pm[1]}")
    print(f"  Total PM Capacity:  CPU = {total_pm_capacity[0]}, RAM = {total_pm_capacity[1]}")
    print(f"  Utilization:        CPU = {cpu_util:.1f}%, RAM = {ram_util:.1f}%")
